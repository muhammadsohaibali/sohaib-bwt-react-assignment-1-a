...
export default function Contact() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const { firstName, lastName, email, message } = Object.fromEntries(formdata.entries()) as {
      firstName: string;
      lastName: string;
      email: string;
      message: string;
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-2.5">
              ...
              />
              <p id="error-first-name" className="mt-1 text-sm text-red-500 font-medium">
                {errors.firstName}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
              />
              <p id="error-last-name" className="mt-1 text-sm text-red-500 font-medium">
                {errors.lastName}
              </p>
            </div>
          </div>
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
              />
              <p id="error-email" className="mt-1 text-sm text-red-500 font-medium">
                {errors.email}
              </p>
            </div>
          </div>
